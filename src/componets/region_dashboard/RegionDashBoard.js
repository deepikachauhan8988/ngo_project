  ...
  const fetchMembers = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://mahadevaaya.com/ngoproject/ngoproject_backend/api/get-member-by-district/?district=dehradun,haridwar`,
        {
          method: 'GET',
          headers: {
                        ...
                        <tbody>
                          {members.map((member, index) => (
                            <tr key={member.id || index}>
                              ...
                              <td>
                                {member.allocated_district && Array.isArray(member.allocated_district) 
