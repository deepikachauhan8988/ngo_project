...
const RegionRegistration = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.allocated_district.length === 0) {
      newErrors.allocated_district = "Please select at least one district";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await authFetch('https://mahadevaaya.com/ngoproject/ngoproject_backend/api/region-reg/', {
        method: 'POST',
      ...
      setSuccessMessage("Region registered successfully!");
      ...
      <div className="dashboard-container">
        ...
        <div className="main-content-dash">
          ...
          <Container fluid className="dashboard-body dashboard-main-container">
            <h1 className="page-title">Region Registration</h1>
